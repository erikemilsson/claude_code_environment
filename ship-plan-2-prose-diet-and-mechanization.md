...
### P5 — Mechanization: Family C escalation + new Family F candidate (staged) — ✅ PoC SHIPPED v4.19.0 (2026-06-10; 13 tests green incl. byte-identical gate; full port gates on real-project diff; Family F proposal still pending capture in scripts-candidates.md)
