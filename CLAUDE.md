...
- **FB-103 … FB-108** (captured 2026-07-19, harvest Tier-2; triage: `template-maintenance/harvest-2026-07-19-triage.md`): session-limit cutoff recovery protocol (103 — direct-edit ready, pattern proven twice downstream), multi-session concurrency (104 — cheap slice direct-editable, full model research-gated), Action-Required card auto-render (105 — MINOR design, tinder prior art), new-spec-section decompose trigger + pause carve-out (106), build-blocking vs validation phase gates (107 — 2nd-signal-gated), owner:both personal-data verification doc (108 — cheap).
