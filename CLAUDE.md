...
- **FB-067** (deferred): mattpocock/skills Wave 2 candidates — re-assess on/after 2026-06-02. Wave 1 status: **FB-071 shipped** (v4.1.0, 2026-05-20); **FB-068 shipped** (v4.2.0, 2026-05-20); FB-069 + FB-070 still pending. Wave 2 candidates (`/tdd`, `/prototype`, `/improve-codebase-architecture`, `/caveman`, hard-vs-soft dep cleanup, bucketed skills) signal-gated on Wave 1 outcomes. Source: video https://www.youtube.com/watch?v=6BB6exR8Zd8 + repo `mattpocock/skills`.
