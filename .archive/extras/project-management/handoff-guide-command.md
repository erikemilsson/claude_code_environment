...
## When to Use
- Projects with UI work Claude can't do (Power BI, Excel, Figma)
...
Add `owner` field to task JSON files:
...
{"id": "2", "title": "Write queries", "owner": "claude", "dependencies": ["1"]}
{"id": "3", "title": "Configure dashboard", "owner": "human", "dependencies": ["2"]}
{"id": "4", "title": "Review together", "owner": "both", "dependencies": ["3"]}
{"id": "5", "title": "Deploy", "owner": "human", "dependencies": ["4"]}
```
