...
Run `/audit-claude-md` to check for bloat. After the report, you'll be offered to walk through fixes interactively.

Run `/audit-claude-md --report-only` to just see the report without fix prompts.
